...
const postList = computed(()=> {
  const allPostList:Post[] = store.getters["PostStore/allPostList"];
  const likePost:number[] = store.getters["LikeStore/allLikePosts"];
  return allPostList.filter((post) => likePost.includes(post.id));
});
